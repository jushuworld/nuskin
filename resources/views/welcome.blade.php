            ...
            @endif
                <form action="create" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address1" class="form-control" id="inputAddress" placeholder="1234 Main St" required="required">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" name="zipcode" class="form-control" id="inputZip" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group d-flex justify-content-between">
                        <label for="inputPayMethod">Payment Method</label>
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="venmo" required="required">
                                <label class="form-check-label" for="inlineRadio1">Venmo</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="cash" required="required">
